...
echo "root_crypt UUID=$(blkid -s UUID -o value /dev/vg0/root) none luks" >> /etc/crypttab
echo "home_crypt UUID=$(blkid -s UUID -o value /dev/vg0/home) none luks" >> /etc/crypttab
echo "var_crypt UUID=$(blkid -s UUID -o value /dev/vg0/var) none luks" >> /etc/crypttab
